...
class AlgoRealmGameManager(ARC4Contract):
    ...
    def recover_lost_item(
        ...
        assert (
            player_stats.recovery_count < self.max_recovery_per_item.value
        ...
        log(
            f"Item recovered successfully! New ASA ID: {recovered_item_asa.created_asset.id}"
        )
