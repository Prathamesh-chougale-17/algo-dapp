...
def test_game_master_registration():
    ...
    try:
        ...
        # Try to register as Game Master with opt-in first, then NoOp if already opted in
        ...
        try:
            ...
            if "already opted in" in str(e):
                logger.info("🔄 Account already opted in, trying with NoOp...")
...
if __name__ == "__main__":
    success = test_game_master_registration()
    if success:
